<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				<a class="navbar-brand" href="http://localhost/pos1/POS_inventory/web/index.html">Lake Basin Maritimers</a>
            </div>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									...
									<ul class="nav nav-third-level">
                                        ...
                                        <li>
                                            <a href="supplier.php"> <i class="fa fa-truck"></i> Employer </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="product.php"> <i class="fa fa-product-hunt"></i> Jobs </a>
                                </li>
                            </ul>
                        </li>
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="sales.php"><i class="fa fa-money fa-fw"></i> Jobs Report</a>
                                </li>
                                <li>
                                    <a href="inventory.php"><i class="fa fa-barcode fa-fw"></i> Employers' Report</a>
                                </li>
                            </ul>
                        </li>
						<li><a href="#logout" data-toggle="modal"><i class="fa fa-sign-out fa-fw"></i> Logout</a></li>
